...
/*----------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------*/
    ...
    public void passf2(int ido, int l1, final float cc[], float ch[], final float wtable[], int offset, int isign)
   ...
   isign is +1 for backward and -1 for forward transforms
  ----------------------------------------------------------------------*/
    public void passf3(int ido, int l1, final float cc[], float ch[], final float wtable[], int offset, int isign) {
   ...
   isign is +1 for backward and -1 for forward transforms
  ----------------------------------------------------------------------*/
    public void passf4(int ido, int l1, final float cc[], float ch[], final float wtable[], int offset, int isign) {
        int i, k, ac, ah;
   ...
   isign is +1 for backward and -1 for forward transforms
  ----------------------------------------------------------------------*/
    public void passf5(int ido, int l1, final float cc[], float ch[], final float wtable[], int offset, int isign)
   ...
   isign is +1 for backward and -1 for forward transforms
  ----------------------------------------------------------------------*/
    public void passfg(int nac[], int ido, int ip, int l1, int idl1,
  ...
  --------------------------------------------------------*/
    public void cfftf1(int n, float c[], final float wtable[], int isign) {
        int idot, i;
        int k1, l1, l2;
  ...
  --------------------------------------------------------*/
    public void cfftf(int n, float c[], float wtable[]) {
        cfftf1(n, c, wtable, -1);
    }

    /*---------------------------------------------------------
   cfftb: Complex forward FFT
  --------------------------------------------------------*/
    public void cfftb(int n, float c[], float wtable[]) {
        cfftf1(n, c, wtable, +1);
    }
  ...
  --------------------------------------------------------*/
    public void cffti1(int n, float wtable[]) {
  ...
  --------------------------------------------------------*/
    public void cffti(int n, float wtable[]) {
        if (n == 1) return;
        cffti1(n, wtable);
    }	/*cffti*/
